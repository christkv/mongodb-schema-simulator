    ...
    return new Promise(function(resolve, reject) {
      co(function*() {
        if(self.state == Transaction.INITIAL) {
          // console.log("[transactions::advance] ------------------------------------ 0")
        ...
        // console.log("[transactions::advance] ------------------------------------ 3")
