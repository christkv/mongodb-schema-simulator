...
scenarios.push({
  ...
  , create: function(services, scenario, schema) {
    ...
    Scenario.prototype.execute = function(options, callback) {
      ...
      Category.findAllDirectChildCategories(cols, cat.category, options, function(err, cats) {
        if(err) return callback(err);
...
scenarios.push({
  ...
  , create: function(services, scenario, schema) {
    ...
    Scenario.prototype.execute = function(options, callback) {
      ...
      var startTime = microtime.now();
      // Get a specific set of children
      Category.findAllChildCategories(cols, cat.category, options, function(err, cats) {
        if(err) return callback(err);
        // Operation end time
        var endTime = microtime.now();
...
scenarios.push({
  ...
  , create: function(services, scenario, schema) {
    ...
    Scenario.prototype.execute = function(options, callback) {
      ...
      var startTime = microtime.now();
      // Get a specific set of children
      Product.findByCategory(cols, cat.category, options, function(err, products) {
        if(err) return callback(err);
        // Operation end time
        var endTime = microtime.now();
...
scenarios.push({
  ...
  , create: function(services, scenario, schema) {
    ...
    Scenario.prototype.execute = function(options, callback) {
      ...
      var startTime = microtime.now();
      // Get a specific set of children
      Product.findByCategoryTree(cols, cat.category, options, function(err, products) {
        if(err) return callback(err);
        // Operation end time
        var endTime = microtime.now();
...
scenarios.push({
  ...
  , create: function(services, scenario, schema) {
    ...
    Scenario.prototype.execute = function(options, callback) {
      ...
      var startTime = microtime.now();
      // Get a specific set of children
      Product.findByDirectCategoryChildren(cols, cat.category, options, function(err, products) {
        if(err) return callback(err);
        // Operation end time
        var endTime = microtime.now();
