  ...
  , create: function(services, scenario, schema) {
    ...
    Scenario.prototype.setup = function(options, callback) {
      ...
      MongoClient.connect(scenario.url, function(err, instance) {
        ...
        var numberOfTheaters = schema.schema.params.numberOfTheaters;
        var rows = schema.schema.params.rows;
        var seats = schema.schema.params.seats;
        var numberOfSessions = schema.schema.params.numberOfSessions;
        ...
        createIndexes(db, collections, function(err) {
          ...
          var numberOfTickets = schema.schema.params.numberOfTickets;
          var collectionNames= schema.schema.collections ? schema.schema.collections : collections;
