...
scenarios.push({
  ...
  , create: function(services, scenario, schema) {
    ...
    Scenario.prototype.custom = function(remote, totalOpsLeft, callback) {
      // Number of users
      var numberOfUsers = schema.execution.distribution.numberOfUsers;
      var initialDelay = schema.execution.distribution.initialDelay || 0;
      var iterations = schema.execution.distribution.iterations;
      var resolution = schema.execution.distribution.resolution;
      var collections = schema.schema.collections ? schema.schema.collections : collections;
    ...
    //   //   // console.log("================== CURSOR")
    //   //   var topic = new Topic({topics: db.collection(collections.topics)});
    //   //   self.cursor = topic.listen()
    //   //   self.cursor.on('data', function(doc) {
    //   //     // console.log("---------- data")
    //   //     // console.log(doc)
    //   //     callback();
    //   //   });
        
    //   //   self.cursor.on('end', function(doc) {
    //   //     // console.log("-------------------- end")
    //   //     self.cursor = null;
    //   //   });
    //   // } else {
