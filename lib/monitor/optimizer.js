    ...
    stream.on('end', function() {
      ...
      db.close(function() {
        ...
        for(var name in scenarios) {
          ...
          // console.log(".amean() = " + amean);
          // console.log(".σ() = " + σ);
          // console.log(".percentile(75) = " + percentile_75);
          // console.log(".percentile(95) = " + percentile_95);
          // console.log(".percentile(99) = " + percentile_99);
          // console.log(".min = " + min);
          // console.log(".max = " + max);
        }
        ...
        // console.log("---------------------------------------------")
        // console.log("optimizeLatencyTarget = " + self.optimizeLatencyTarget)
        // console.log("optimizeForScenario = " + self.optimizeForScenario)
        // console.log("percentile = " + percentile)
        // console.log("percentageFactor = " + percentageFactor)
        // console.log("marginErrorMS = " + marginErrorMS)
        // console.log("lowerMarginMS = " + lowerMarginMS)
        // console.log("upperMarginMS = " + upperMarginMS)
