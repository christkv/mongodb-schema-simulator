...
Executor.prototype.execute = function() {
  ...
  //           if(finalResults[i]['Collection_find']) {
  //             results['queries'][i] = finalResults[i]['Collection_find'].count;
  //           }

  //           if(finalResults[i]['Collection_findOne']) {
  //             results['queries'][i] = finalResults[i]['Collection_findOne'].count;
  //           }
  ...
  //           if(finalResults[i]['Collection_updateOne']) {
  //             results['updates'][i] = finalResults[i]['Collection_updateOne'].count;
  //           }

  //           if(finalResults[i]['Collection_updateMany']) {
  //             results['updates'][i] = finalResults[i]['Collection_updateMany'].count;
  //           }

  //           if(finalResults[i]['Collection_insert']) {
  //             results['insert'][i] = finalResults[i]['Collection_insert'].count;
  //           }

  //           if(finalResults[i]['Collection_insertOne']) {
  //             results['insert'][i] = finalResults[i]['Collection_insertOne'].count;
  //           }

  //           if(finalResults[i]['Collection_insertMany']) {
  //             results['insert'][i] = finalResults[i]['Collection_insertMany'].count;
  //           }

  //           if(finalResults[i]['Collection_deleteOne']) {
  //             results['deletes'][i] = finalResults[i]['Collection_deleteOne'].count;
  //           }

  //           if(finalResults[i]['Collection_deleteMany']) {
  //             results['deletes'][i] = finalResults[i]['Collection_deleteMany'].count;
  //           }
  //         }
