...
scenarios.push({
  ...
  , create: function(services, scenario, schema) {
    ...
    Scenario.prototype.setup = function(options, callback) {
      ...
      var self = this;
      var preAllocate = schema.schema.params.preAllocate;
      var resolution = schema.schema.params.resolution;
      var numberOfTimeSeries = schema.schema.params.numberOfTimeSeries;
